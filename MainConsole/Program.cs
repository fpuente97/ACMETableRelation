...
namespace MainConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Please ensure that the file is in the directory of this app and is named as \"InputFile.txt\". Press Enter to continue...");

            Console.ReadLine();

            var getfile = new GetFile("InputFile");
